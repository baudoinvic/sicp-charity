      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center py-8 mt-10">
        ...
        <div className="w-full md:w-1/2 md:ml-8 mt-4 md:mt-0">
          ...
          <p className="text-gray-700 leading-relaxed">
            Welcome to Beatha Business where we provide quality products to our
            customers. We offer a variety of products including oils and
            ...
            . This is our main product menu. We welcome you all to our platform
            to enjoy our quality products. We offer oils for both men and women.
          </p>
        </div>
      </div>
      <Footer />
