      ...
      <div className="container mx-auto p-6">
        ...
        <main>
          ...
          <section className="mb-12">
            ...
            <div className="max-w-3xl mx-auto">
              <h3 className="text-xl font-semibold mt-4">Monetary Donations</h3>
              <p>Your funds will be used to directly impact our mission.</p>
              <h3 className="text-xl font-semibold mt-4">In-Kind Donations</h3>
              <p>
                We accept goods and supplies such as clothing, food, and medical
                supplies. Professional services like legal aid and medical care
                are also greatly appreciated.
              </p>
              <h3 className="text-xl font-semibold mt-4">Fundraising</h3>
              <p>
                Create your own fundraising campaign or participate in our
                events to help raise funds.
              </p>
              <h3 className="text-xl font-semibold mt-4">Volunteering</h3>
              <p>
                Your time is valuable to us. Volunteer with us to make a
                hands-on difference.
              </p>
            </div>
          </section>
